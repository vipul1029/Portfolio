...
//         className='px-4 py-1 rounded-full bg-gray-100 dark:bg-darkHover border border-gray-300 text-sm font-medium'
//       >
//         Software Development Intern @ KreditBee
//       </motion.div>
//       {/* Title Animation */}
//       <motion.h1
//         initial={{ y: -30, opacity: 0 }}
...
// I’m a B.Tech CSE student at VIT Vellore passionate about building scalable full-stack applications and AI-powered systems, with experience in software development, computer vision, and machine learning.
//       </motion.p>
...
const Header = () => {
  return (
   <div className='w-11/12 max-w-3xl text-center mx-auto min-h-screen pt-20 pb-16 flex flex-col items-center justify-center gap-6'>
      ...
      <motion.p
        ...
        whileInView={{ opacity: 1 }}
        transition={{ duration: 0.6, delay: 0.7 }}
        className='max-w-2xl mx-auto text-lg font-Ovo text-gray-700 dark:text-gray-300 leading-9'
      >
        I’m a B.Tech CSE student at VIT Vellore passionate about building
        scalable full-stack applications and AI-powered systems, with experience
        in software development, computer vision, and machine learning.
      </motion.p>
